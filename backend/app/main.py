...
# Start tracemalloc for more detailed error messages (optional)
tracemalloc.start()
...
# CORS middleware configuration adjusted to the `origins` list for better security
app.add_middleware(
    CORSMiddleware,
    allow_origins=origins,  # Use the defined list for better security
