// frontend/src/components/MarkdownRenderer/MarkdownRenderer.jsx
              ...
              {notes[paragraph.id] ? (
                ...
                <div className="add-note-container">
                  <textarea
                    ...
                    placeholder="Add a one sentence summary summarizing the previous paragraph and one summarizing the current paragraph."
